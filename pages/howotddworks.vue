<template>
  <div class="container">
    ...
    <div style="margin:0px 140px;text-align:left;padding-bottom:300px;">
      ...
      <div style="font-size:16px;padding:10px 0px;">To group the inbound and outbound reqs/resps, there are three methods:</div>
      <ul style="font-size:14px;padding:10px 20px;">
      ...
      <ul style="font-size:14px;padding:10px 20px;">
         <li>Inbound req/resp and outbound reqs/resps are not necessarily resides in the same thread.</li>
         <li>Hajack code must be written in order to track the thread id.</li>
      </ul>
      ...
      <ul style="font-size:14px;padding:10px 20px;">
         <li>This method applis to most scenarios that most microservice fit in this modal.</li>
